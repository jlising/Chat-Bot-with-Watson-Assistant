...
public class DialogNodeOutputGeneric extends GenericModel {
   ...
   * property. For more information, see the [Discovery component
   ...
   * see the [Discovery component documentation]([Discovery component
   ...
   *
   * <p>The version of the Discovery component API to use for the query.
   *
