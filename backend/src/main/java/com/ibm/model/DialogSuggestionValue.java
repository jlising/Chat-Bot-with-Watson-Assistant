...
/**
 * An object defining the message input, intents, and model to be sent to the Watson Assistant
 * component if the user selects the corresponding disambiguation option.
 */
public class DialogSuggestionValue extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Adds an model to model.
     *
     * @param entities the new model
     * @return the DialogSuggestionValue builder
     */
    public Builder addEntities(RuntimeEntity entities) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(entities, "model cannot be null");
   ...
   * Gets the model.
   *
   * <p>An array of model to be sent along with the user input.
   *
   * @return the model
   */
