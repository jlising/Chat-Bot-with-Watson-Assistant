...
public class ListEntitiesOptions extends GenericModel {
  ...
  /**
   * The attribute by which returned model will be sorted. To reverse the sort order, prefix the
   ...
   * Gets the sort.
   *
   * <p>The attribute by which returned model will be sorted. To reverse the sort order, prefix
