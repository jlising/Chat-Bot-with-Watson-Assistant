...
import com.ibm.model.Counterexample;
import com.ibm.model.CreateEntity;
import com.ibm.model.CreateIntent;
import com.ibm.model.Webhook;
import com.ibm.model.WorkspaceSystemSettings;
...
public class CreateWorkspaceOptions extends GenericModel {
   ...
   *
   * <p>Whether training data from the workspace (including artifacts such as intents and model)
   * can be used by IBM for general component improvements. `true` indicates that workspace training
   ...
   * Gets the model.
   *
   * <p>An array of objects describing the model for the workspace.
   *
   * @return the model
   */
