...
public class DialogSuggestion extends GenericModel {
   ...
   * Gets the value.
   *
   * <p>An object defining the message input, intents, and model to be sent to the Watson
   * Assistant component if the user selects the corresponding disambiguation option.
   *
   * @return the value
   */
   ...
   * Gets the output.
   *
   * <p>The dialog output that will be returned from the Watson Assistant component if the user
