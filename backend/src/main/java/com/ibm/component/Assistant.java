...
/**
 * The IBM Watson&trade; Assistant component combines machine learning, natural language
...
public class Assistant extends BaseService{
     ...
     *     will keep your API calls from failing when the component introduces breaking changes.
     */
     ...
     * @param versionDate The version date (yyyy-MM-dd) of the REST API to use. Specifying this value
     *     will keep your API calls from failing when the component introduces breaking changes.
     * @param authenticator the Authenticator instance to be configured for this component
     */
     ...
     * @param versionDate The version date (yyyy-MM-dd) of the REST API to use. Specifying this value
     *     will keep your API calls from failing when the component introduces breaking changes.
     * @param serviceName The name of the component to configure.
     */
    ...
    public ServiceCall<MessageResponse> message(MessageOptions messageOptions) {
        ...
        if (messageOptions.entities() != null) {
            contentJson.add(
                    "com/ibm/ph/edm/watson/assistant/entities",
     ...
     * List workspaces.
     *
     * <p>List the workspaces associated with a Watson Assistant component instance.
     *
     ...
     * Create workspace.
     *
     * <p>Create a workspace based on component objects. You must provide workspace component
     ...
     * Delete workspace.
     *
     * <p>Delete a workspace from the component instance.
     *
     * <p>This operation is limited to 30 requests per 30 minutes. For more information, see **Rate
     * limiting**.
     *
    ...
    public ServiceCall<EntityCollection> listEntities(ListEntitiesOptions listEntitiesOptions) {
        ...
        String[] pathSegments = {"v1/workspaces", "com/ibm/ph/edm/watson/assistant/entities"};
    ...
    public ServiceCall<EntityMentionCollection> listMentions(
        ...
        String[] pathSegments = {"v1/workspaces", "com/ibm/ph/edm/watson/assistant/entities", "mentions"};
    ...
    public ServiceCall<ValueCollection> listValues(ListValuesOptions listValuesOptions) {
        ...
        String[] pathSegments = {"v1/workspaces", "com/ibm/ph/edm/watson/assistant/entities", "values"};
    ...
    public ServiceCall<SynonymCollection> listSynonyms(ListSynonymsOptions listSynonymsOptions) {
        ...
        String[] pathSegments = {"v1/workspaces", "com/ibm/ph/edm/watson/assistant/entities", "values", "synonyms"};
        String[] pathParameters = {
     ...
     *
     * <p>List the events from the logs of all workspaces in the component instance.
     *
     * <p>If **cursor** is not specified, this operation is limited to 40 requests per 30 minutes. If
     * **cursor** is specified, the limit is 120 requests per minute. For more information, see **Rate
     * limiting**.
